...
const serverTemplate = (active, name, map, userCount, roundId, roundTime, roundState, ip) => {
	const roundDuration = new Date(roundTime * 1000).toISOString().substring(11, 19);
...
function refresh() {
	...
	const error = function (jqXHR, status, error) {
